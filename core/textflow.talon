...
token <user.number_small>: user.textflow_select_nth_token(number)
token next: user.textflow_select_nth_token(1)
token last: user.textflow_select_nth_token(-1)
argument <user.number_small>: user.textflow_select_nth_modifier(number, "ARGUMENT_NTH")
...
string <user.number_small>: user.textflow_select_nth_modifier(number, "STRING_NTH", "'")
...
dubstring <user.number_small>: user.textflow_select_nth_modifier(number, "STRING_NTH", "\"")
...
graves <user.number_small>: user.textflow_select_nth_modifier(number, "STRING_NTH", "`")
...
brackets <user.number_small>: user.textflow_select_nth_modifier(number, "BRACKETS_NTH")
