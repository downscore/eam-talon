...
coconut [<phrase>]$:
  ...
  user.macos_beep()
# Mistaken recognitions for "dinosaur": Denise:5, tensor:4, venator:3, dilator:2, vanisher, then IO,
# donator, donate
...
# Switch to command mode and sleep at the same time. Without this, in dictation mode
# "now do coconut" results in switching to command mode and writing "coconut" without sleeping.
