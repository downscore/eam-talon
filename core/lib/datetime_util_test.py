...
class ConvertUnixTimestampTestCase(unittest.TestCase):
  ...
  def test_convert_unix_timestamp(self):
    self.assertEqual(convert_unix_timestamp("1665150638"),
                     datetime.datetime(2022, 10, 7, 6, 50, 38))
    self.assertEqual(convert_unix_timestamp("1665150638000"),
                     datetime.datetime(2022, 10, 7, 6, 50, 38))
    self.assertEqual(convert_unix_timestamp("1665150638.000"),
                     datetime.datetime(2022, 10, 7, 6, 50, 38))
