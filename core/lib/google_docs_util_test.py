...
class GetPreviewUrlTestCase(unittest.TestCase):
  ...
  def test_get_preview_url(self):
    ...
    self.assertEqual(get_preview_url("https://docs.google.com/document/d/ABCDefghiJKLMnoPqRSTUVwxyz/edit#"),
                     "https://docs.google.com/document/d/ABCDefghiJKLMnoPqRSTUVwxyz/preview")
    self.assertEqual(get_preview_url("https://docs.google.com/document/d/ABCDefgh123/edit#heading=h.abcdefg12345"),
    ...
    self.assertEqual(get_preview_url("https://docs.google.com/document/d/ABCDefgh123/"),
                     "https://docs.google.com/document/d/ABCDefgh123/preview")
    self.assertEqual(get_preview_url("https://docs.google.com/document/d/ABCDefgh123#heading=h.1234"),
                     "https://docs.google.com/document/d/ABCDefgh123/preview")
